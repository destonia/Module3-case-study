...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('eshoppper/js/html5shiv.js')}}"></script>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img style="height: 300px;" src="{{$product->photo}}" alt="" />
                                        <h2>{{$product->price}}</h2>
                                        <p>{{$product->name}}</p>
                                        <p>{{$product->id}}</p>

                                        <button data-id="{{$product->id}}" class="btn btn-default add-to-cart addToCart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                    </div>
                                </div>
                                <div class="choose">
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        ...
                        <form action="#" class="searchform">
                            ...
                            <button type="submit"><i class="fa fa-arrow-circle-o-right"></i>
                            </button>
