                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                @foreach($recentOrder as $key => $item)
                                                    <tr>
                                                        <td>{{$key +1}}</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="{{$item->photo}}" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>{{$item->name}} </td>
                                                        <td>PRD-{{$item->id}} </td>
                                                        <td>{{$item->quantity}}</td>
                                                ...
                                                @endforeach
                                                    <tr>
                                                        <td colspan="9"><a href="{{route('showAllRecentOrder')}}" class="btn btn-outline-light float-right">View All</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
